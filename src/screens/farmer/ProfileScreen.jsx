...
export default function ProfileScreen() {
  ...
  const handleSave = async () => {
    setSaving(true);
    try {
      const updated = await createFarmerProfile(user.uid, { name });
  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={{ padding: spacing.screenPadding }}>
      ...
      <Text style={styles.hint}>Farm details (village, state, size, photo) live under the Farm Profile tab on your Dashboard.</Text>
